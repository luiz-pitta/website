...
// se a sessão id estiver vazia ou se a sessão estatus for diferente de adm entao execute
	...
	// recuperando os ids que foram enviados pela página lista.php
	$cd = $_GET['id']; // recuperando id do livro
	$cd2 = $_GET['id2']; // recuperando id da categoria
	$cd3 = $_GET['id3']; // recuperando id do autor
